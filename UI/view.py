...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self.txt_goal_fatti = ft.TextField(label="Goal fatti")
        self.btn_top5 = ft.ElevatedButton(text="top 5", on_click=self._controller.top5)
        self._txttitolo = ft.TextField(label="")

        # button for the "creat graph" reply
        self.btn_graph = ft.ElevatedButton(text="Crea Grafo", on_click=self._controller.handle_graph)
        row1 = ft.Row([self.txt_goal_fatti, self.btn_graph,self.btn_top5],
